...
class ListPage(object):
    ...
    def add_list_item(self, item_next):
        num_item_no= len(self.get_table_rows()) + 1
        self.get_item_input_box().send_keys(item_next)
        self.get_item_input_box().send_keys(Keys.ENTER)
        self.wait_for_row_in_list_table(item_next, num_item_no)
        return self
    ...
    def share_list_with(self, email):
        ...
        self.get_share_box().send_kyes(Keys.ENTER)
